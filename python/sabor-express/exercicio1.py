...
# 2 - Imprima a frase: Meu nome é {nome} e tenho {idade} anos 
# em que nome e idade precisam ser valores armazenados em variáveis.
nome = 'Anthony'
idade = 17
...
# pi = 3.14159.
pi = 3.14159
print('O valor de pi arredondado é:', round(pi, 2))